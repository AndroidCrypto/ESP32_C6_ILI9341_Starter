/*
  ...
  Attached is an 2.8 inch TFT display that runs a ILI9341 driver.
...
/*
Version Management
17.05.2025 V01 Initial programming
*/

/*
TFT 240 x 320 pixels 2.8 inch ILI9341 display wiring to an ESP32-C6 Supermini
...
Note *1) If you don't need a dimming you can connect LED/BLK with 3.3V
Note *2) The display does have a MISO ("output") terminal, but it is not wired
Note *3) The terminal does have a touch surface, but this is not wired in this sketch
07 LED   18 (=BL) *1)
08 SCK    7
09 SDI   16 (=MOSI)
10 DC    19
...
const char *PROGRAM_VERSION = "ESP32-C6 Supermini ILI9341 Starter V01";
const char *PROGRAM_VERSION_SHORT = "ILI9341 Starter V01";
const char *DEVICE_NAME = "ESP32-C6 Supermini  2.8 in. 240 x 320 px";
const char *DIVIDER = "--------------------";
...
#define TFT_BRIGHTNESS_PERCENT 100  // avoids overheating of the device
